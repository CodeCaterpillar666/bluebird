...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "q0xhvZif0yBbLARgUCAh8XZBY", consumerSecret: "W3UdMGUBaNHt0ExTjYkqGYcuvwMTvoMnvcdQXfUC7CY6fp9jSB")
    var loginSuccess: (() -> ())?
