...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "AgumNH04OtGlSvNtQsqdR2PVN", consumerSecret: "RHuuSKKJ6VOKCdQKwKpfmEm9mf830EGWacqI02IqrurR0pLy2F ")
    var loginSuccess: (() -> ())?
